  	...
  	<div class="row">
			...
			<div class="col-md-8">
		      ...
		      <div class="introduccion">
		          <h3>Peticion:</h3>
		          <h5> la petición es un derecho que supone que toda persona puede acudir a las autoridades competentes por
		          ...
		          <h3>Queja:</h3>
		           ...
		           <h3>Reclamo:</h3>
		           <h5>La posibilidad de efectuar un reclamo es un derecho de los consumidores, protegido por diversas leyes y
		           ...
		           <h5>
					...
					<div class="text-center">
						 <button class="btn btn-default btn-lg" type="submit" id="1">Peticion</button>
						 <button class="btn btn-default btn-lg" type="submit" id="2">Peticion anonima</button>
				 </div>
		  	</div>
